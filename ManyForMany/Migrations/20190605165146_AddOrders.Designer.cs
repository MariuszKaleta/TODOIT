...
namespace ManyForMany.Migrations
{
    ...
    [Migration("20190605165146_AddOrders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ManyForMany.Model.Entity.Orders.Decizion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ManyForMany.Model.Entity.User.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("ManyForMany.Model.Entity.Ofert.Order", b =>
                {
                    b.HasOne("ManyForMany.Model.Entity.User.ApplicationUser")
                        .WithMany("UserOrders")
