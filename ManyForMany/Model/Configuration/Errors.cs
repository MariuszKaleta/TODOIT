namespace TODOIT.Model.Configuration
{
    public static class Errors
    {
        ...
        public const string YouInterestedThisOrder = "You Interested Order";
        ...
        public const string YouLikedThisCategoryBefore = "You Liked This Category Before";

        public const string ThisParameterMustBeUnique = "This Parameter {0} Must Be Unique";
        public const string ElementDoseNotExist = "Element Dose Not Exist";
    }
}
