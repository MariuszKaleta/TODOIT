...
namespace TODOIT.Migrations
{
    ...
    [Migration("20191119162235_addAllowedToComment")]
    partial class addAllowedToComment
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TODOIT.Model.Entity.Chat.Chat", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("TODOIT.Model.Entity.Chat.ChatMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TODOIT.Model.Entity.Chat.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TODOIT.Model.Entity.Order.InterestedOrder", b =>
                {
                    ...
                    b.ToTable("InterestedOrders");
                });

            modelBuilder.Entity("TODOIT.Model.Entity.Order.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TODOIT.Model.Entity.Order.OrderMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TODOIT.Model.Entity.Rate.AllowToMakeOpinion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TODOIT.Model.Entity.User.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TODOIT.Model.Entity.Chat.ChatMember", b =>
                {
                    b.HasOne("TODOIT.Model.Entity.Chat.Chat", "Chat")
                        .WithMany()
